...
namespace Örnek1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (cevap == DialogResult.OK) textBox1.ForeColor = colorDialog1.Color;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            DialogResult cevap;
            cevap = colorDialog1.ShowDialog();
            if (cevap == DialogResult.OK) textBox1.BackColor = colorDialog1.Color;
        }

        private void Form1_Load(object sender, EventArgs e)
        {
            InstalledFontCollection fontlar = new InstalledFontCollection();
            foreach (FontFamily font in fontlar.Families) listBox1.Items.Add(font.Name);
            foreach (FontFamily font in fontlar.Families) listBox2.Items.Add(font.Name);
        }
        ...
        {
            textBox1.Font = 
                new Font(textBox1.Font.Name, Convert.ToSingle(comboBox1.Text), textBox1.Font.Style);
        }
        ...
        {
            richTextBox1.SelectionFont = new Font(listBox2.Text, richTextBox1.SelectionFont.Size);
        }

        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            richTextBox1.SelectionFont = new Font(richTextBox1.SelectionFont.Name, Convert.ToSingle(comboBox2.Text));
        }
